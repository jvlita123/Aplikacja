...
namespace Application.Controllers
{
    ...
    {
        private readonly ReservationService _reservation1Service;
        ...
        public ReservationController(ReservationService reservation1Service, ServiceService serviceService, StatusService statusService, UserService userService, ReservationSlotsService reservationSlotsService, UserReservationSlotsService userReservationSlotsService, IWebHostEnvironment environment)
        {
        ...
        public IActionResult Calendar()
        {
            ...
            {
                ViewData["userReservations"] = new List<Reservation>();
            }
        ...
        {
            Reservation reservation = _reservation1Service.GetAll().Where(x => x.Id == reservationId).First();
            return PartialView(reservation);
        }
        ...
        [Authorize]
        public async Task<IActionResult> NewReservation(Reservation reservation, string userEmail, IFormFile uploadFile)
        {
